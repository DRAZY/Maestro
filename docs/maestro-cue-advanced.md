...
Events older than your retention window are automatically pruned at engine start to keep the database lean. The window is the `cueHistoryRetentionDays` setting, 14 days by default.
