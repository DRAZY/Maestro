...
# (1796x1151 logical pixels, 3592x2302 at 2x retina)
npm run dev:showcase -- --theme catppuccin-latte --size 1796x1151
```
...
1. Capture it at `--size 1796x1151` so it matches the set.
